...
public class AutomationScript extends ReusableMethod {
	...
	public static void Add_another_organization_Paid_version_1() throws IOException, InterruptedException{
		...
		/*verify select plan */
		WebElement plantext = driver.findElement(By.xpath(".//*[@id='frmMain']/div/div[2]/div/main/div[2]/h3"));
		verifyText(plantext, "Select a plan");

		Thread.sleep(3000);
		bw.close();
	}

	public static void Add_another_organization_Starter_Plan1() throws IOException, InterruptedException{
		...
		String[][] recCreden = ReusableMethod.readExcel(excelPath, "Sheet1");
		String Email, password,orgName,orgDo,taxPaid,timeZone,stAddres,city,state,zip;
		...
		taxPaid = recCreden[15][1];
		timeZone = recCreden[16][1];
		stAddres = recCreden[17][1];
		city = recCreden[18][1];
		state = recCreden[19][1];
		zip = recCreden[20][1];
		...
		clickObj(starter, "buy starter");
		Thread.sleep(3000);

		/* click continue */
		WebElement Billcontinue = driver.findElement(By.xpath(".//*[@id='frmMain']/div/div[2]/div/main/div[10]/button"));
		clickObj(Billcontinue, "continue details");
		Thread.sleep(3000);

		/*give street address*/
		Thread.sleep(3000);
		WebElement addrss = driver.findElement(By.xpath(".//*[@id='POAddress']"));
		enterText(addrss, stAddres ,"street address");

		/*give city*/
		Thread.sleep(3000);
		WebElement place = driver.findElement(By.xpath(".//*[@id='POCity']"));
		enterText(place, city ,"city");

		/*give state*/
		Thread.sleep(3000);
		WebElement stat = driver.findElement(By.xpath(".//*[@id='PORegionDropdown']"));
		enterText(stat, state ,"state");

		/*give zipcode*/
		Thread.sleep(3000);
		WebElement zipcode = driver.findElement(By.xpath(".//*[@id='POPostalCode']"));
		enterText(zipcode, zip ,"zipcode");

		/*click continue to review*/
		Thread.sleep(3000);
		WebElement review = driver.findElement(By.xpath(".//*[@id='frmMain']/div/div/div/main/div[3]/div/div[2]/div/button"));
		clickObj(review, "continu to review");
		Thread.sleep(3000);
